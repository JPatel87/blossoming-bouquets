...
class OrderLineItem(models.Model):
    ...
    bouquet = models.ForeignKey(Bouquet, null=False, blank=False, on_delete=models.CASCADE)
    ...
    def save(self, *args, **kwargs):
        ...
        """
        self.lineitem_total = self.bouquet.price * self.quantity
        super().save(*args, **kwargs)
