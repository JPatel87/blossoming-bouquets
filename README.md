...
| Image | Description |
| --- | --- |
| Favicon and site tab![Favicon](readme_documents/features/favicon.png) | The site tab includes the site bouquet logo and the site name, in order to re-inforce the brand and build memory of it in the users mind. |
| Header - medium screen and above (greater than 992px)![Header](readme_documents/features/header-md.png)  | 1) Responsive header on medium and above screens (e.g laptops), consisting of the site logo, navigation menu, search bar and delivery banner. 2) Upon hover of any of the navigation items, the links/icons turn pink. 3) When the home, bouquets, blog and contact us page are active, the link is underlined. 4) The logo acts as a link to the home page. | 
