...
| Bouquet edit page - content (medium screens and above view) ![Bouquet edit](readme_documents/features/bouquet-edit.png) | 1) Bouquet edit page is responsive on all screens; on small screens and below the edit form spans 12 columns, whereas on medium and above it spans 6 columns 2) When a superuser chooses the "Edit" option - an alert message appears in the top right and the form is displayed (the same form as the add product form) | 3) All of the original details of the product are present in the edit form. 
